...
public class JgClickListener extends InputListener {
	 ...
	 */
	public JgClickListener() {
	}

	/** @see #setButton(int) */
	public JgClickListener(int button) {
		this.button = button;
	}
	...
	public boolean inTapSquare(float x, float y) {
		Logger.getGlobal().info("sdsdsdds");
